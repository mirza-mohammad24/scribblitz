...
io.on('connection', (socket: Socket) => {
  ...
  //Listener for emotes - this will trigger the emote flow
  //this has its own rate limiting and validation logic and disconnect cleanup, so we outsource it to
  // a separate handler file for clarity and maintainability
