  ...
  const features = [
    {
      ...
      description:
        'Powered by a Finite State Machine (FSM) to completely eliminate race conditions and keep rounds perfectly synced.',
    },
    {
      icon: <Zap size={18} />,
      badgeStyle:
      ...
      description:
        'High-frequency drawing data is cached entirely in-memory using Redis, ensuring buttery smooth lines for everyone.',
    },
    {
      ...
      description:
        'A smart priority engine lets you ditch the default dictionary and play exclusively with your own inside jokes.',
    },
    {
