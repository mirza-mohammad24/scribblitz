      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-2xl bg-white dark:bg-discord-card rounded-[2rem] md:rounded-[2.5rem] border-4 border-gray-200 dark:border-discord-main p-5 md:p-8 shadow-2xl flex flex-col items-center gap-4 md:gap-6 max-h-[95vh] overflow-y-auto hide-scrollbar"
          >
            {/* HEADER */}
            ...
            {/* PODIUM */}
            <div className="flex items-end justify-center gap-2 lg:gap-4 h-[250px] md:h-[280px] shrink-0">
              {/* SILVER PODIUM (2nd) */}
              {secondPlace && (
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  />
                  <span className="font-bold text-gray-500 dark:text-gray-400 text-xs md:text-sm truncate max-w-[70px] md:max-w-[80px] text-center">
                  ...
                  <motion.div
                    ...
                    className="w-16 md:w-20 lg:w-24 bg-gradient-to-t from-gray-300 to-gray-100 dark:from-gray-700 dark:to-gray-500 rounded-t-2xl border-x-4 border-t-4 border-gray-400 dark:border-gray-400 flex justify-center pt-2 shadow-inner relative overflow-hidden"
                  >
              ...
              {firstPlace && (
                <div className="flex flex-col items-center gap-1.5 z-10">
                  ...
                  />
                  <span className="font-black text-yellow-600 dark:text-yellow-400 text-sm md:text-lg truncate max-w-[85px] md:max-w-[100px] text-center">
                    {firstPlace.username}
                  </span>
                  ...
                  <motion.div
                    ...
                    className="w-20 md:w-24 lg:w-32 bg-gradient-to-t from-yellow-500 to-yellow-300 dark:from-yellow-700 dark:to-yellow-500 rounded-t-2xl border-x-4 border-t-4 border-yellow-400 dark:border-yellow-500 flex justify-center pt-1 md:pt-2 shadow-[0_-10px_20px_rgba(234,179,8,0.25)] relative overflow-hidden"
                  >
              ...
              {thirdPlace && (
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  />
                  <span className="font-bold text-orange-500 dark:text-orange-500 text-xs md:text-sm truncate max-w-[70px] md:max-w-[80px] text-center">
                    {thirdPlace.username}
                  </span>
                  ...
                  <motion.div
                    ...
                    className="w-16 md:w-20 lg:w-24 bg-gradient-to-t from-orange-400 to-orange-200 dark:from-orange-800 dark:to-orange-600 rounded-t-2xl border-x-4 border-t-4 border-orange-500 dark:border-orange-700 flex justify-center pt-2 shadow-inner relative overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-white/20 dark:bg-white/5" />
