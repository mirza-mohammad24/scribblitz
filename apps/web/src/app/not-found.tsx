...
export default function NotFound() {
  return (
    <div className="flex-1 w-full flex flex-col items-center justify-center p-4 min-h-0">
      <div className="w-full max-w-md bg-white dark:bg-discord-card border-4 border-gray-200 dark:border-discord-main rounded-4xl md:rounded-4xl p-6 md:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)] dark:shadow-[8px_8px_0px_0px_rgba(0,0,0,0.3)] flex flex-col items-center text-center relative overflow-hidden">
        ...
        <p className="text-sm md:text-base font-bold text-gray-500 dark:text-gray-400 mb-8 max-w-70 md:max-w-xs z-10">
